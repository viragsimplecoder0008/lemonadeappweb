...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "Absolutely! You can adjust sweetness levels, add extra flavors, or create custom blends. Use the CUSTOM button on the Products page — custom orders may take 24 hours or more."
  },
  {
    question: "What payment methods do you accept?",
    answer: "Cash on delivery (COD) is available now. Online card payments are coming soon."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes! Join our VIP program to earn lemons on every purchase, get exclusive discounts, and receive early access to new Golden Flavors."
  }
];
